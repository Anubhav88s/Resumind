 ...
 * Throws an error if used outside of an Accordion provider.
 */
const useAccordion = () => {
 ...
 * Manages the state of active items.
 *
 ...
 * The clickable header that toggles the expansion of the item.
 *
 * @param {AccordionHeaderProps} props - The component props.
 * @returns {JSX.Element} The rendered Accordion Header.
 */
 ...
 * The content that is shown or hidden based on the item's active state.
 *
